...
async function cleanCampaign(slug) {
  ...
  console.log('Original subtitle:', (campaign.subtitle || campaign.description || '').substring(0, 100));
  ...
  console.log('\nCleaned subtitle:', (updates.subtitle || updates.description || '').substring(0, 100));
  console.log('Cleaned content_sections:', updates.content_sections?.length || 0, 'sections');
